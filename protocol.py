"""Unified stream protocol helpers for provider adapters and ReAct."""
    ...
    def done_event(
        ...
        *,
        ...
        if answer_key == "content":
            payload["answer"] = self.content.strip()
        else:
            payload["content"] = self.content.strip()
...
def format_exception_message(exc: Exception, *, default: str = "Unknown error") -> str:
    message = str(exc).strip()
    return message or type(exc).__name__ or default
